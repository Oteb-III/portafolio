...
// Activar efecto de typing cuando la página cargue
document.addEventListener('DOMContentLoaded', () => {
...
// Validación y envío de formulario de contacto (si se añade en el futuro)
function validateEmail(email) {
    const re = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    return re.test(email);
}

// Efecto de hover mejorado para las tarjetas de portafolio
...
// Añadir CSS para las partículas
...
console.log('%c🚀 Portafolio cargado correctamente', 'color: #4f46e5; font-size: 16px; font-weight: bold;');
console.log('%c💡 Personaliza este portafolio editando el archivo index.html', 'color: #10b981; font-size: 14px;');
